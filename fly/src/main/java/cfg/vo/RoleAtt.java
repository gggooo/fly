...
public class RoleAtt extends BaseTO{
	public String id="";
	...
	public cfg.vo.Member createMember;
	public cfg.vo.Member getCreateMember(){return this.createMember;}
	public void setCreateMember(cfg.vo.Member one){this.createMember=one;}
	public String updateDate="";
	public String getUpdateDate(){return this.updateDate;}
	public void setUpdateDate(String one){this.updateDate=one;}
	public cfg.vo.Member updateMember;
	public cfg.vo.Member getUpdateMember(){return this.updateMember;}
	public void setUpdateMember(cfg.vo.Member one){this.updateMember=one;}
	public String ws0="";
	...
	public void setAtt(String one){this.att=one;}
	public String usrct="";
