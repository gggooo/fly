...
public class LocalConnetionPool {
	private static LinkedList m_notUsedConnection = new LinkedList();
	private static HashSet m_usedUsedConnection = new HashSet();
	private static String m_url = "jdbc:mysql://localhost:3306/mytest2?characterEncoding=utf8";
	private static String m_user = "root";
	private static String m_password = "144144";
...
//		}
	...
	public synchronized static void printDebugMsg(PrintStream out) {
		...
		msg.append("debug message in " + LocalConnetionPool.class.getName());
		msg.append("\r\n");
...
class ConnectionWrapper implements InvocationHandler {
	...
	public Object invoke(Object proxy, Method m, Object[] args)
		...
		if (CLOSE_METHOD_NAME.equals(m.getName())) {
			LocalConnetionPool.pushConnectionBackToPool(this);
		} else {
